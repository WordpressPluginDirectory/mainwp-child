...
return array(
    ...
    1330 => array(
        ...
        'msg'         => esc_html__( '%action% the excerpt of a post', 'mainwp-child' ),
        'context'     => 'post',
        'action_name' => 'modified',
    ),
    1335 => array(
        ...
        'msg'         => esc_html__( '%action% the feature image of a post', 'mainwp-child' ),
        'context'     => 'post',
        'action_name' => 'modified',
    ),
    1340 => array(
    ...
    1406 => array(
        'type_id'     => 1406,
        'desc'        => esc_html__( 'Created a new tag', 'mainwp-child' ),
        'context'     => 'tag',
        'action_name' => 'created',
    ),
    1407 => array(
        'type_id'     => 1407,
        'desc'        => esc_html__( 'Deleted a tag', 'mainwp-child' ),
        'context'     => 'tag',
        'action_name' => 'deleted',
    ),
    1410 => array(
    ...
    1455 => array(
        ...
        'msg'         => esc_html__( 'Modified a file of the plugin %plugin% with the plugin editor', 'mainwp-child' ),
        'context'     => 'file',
        'action_name' => 'modified',
    ),
    1460 => array(
        ...
        'msg'         => esc_html__( '%action% automatic update the plugin %name%', 'mainwp-child' ),
        'context'     => 'plugin',
        'action_name' => 'modified',
    ),
    ...
    1465 => array(
        ...
        'msg'         => esc_html__( 'Modified a file of the theme %theme% with the theme editor', 'mainwp-child' ),
        'context'     => 'file',
        'action_name' => 'modified',
    ),
    1470 => array(
        ...
        'msg'         => esc_html__( '%action% automatic update the theme %name%', 'mainwp-child' ),
        'context'     => 'theme',
        'action_name' => 'modified',
    ),
    // Menu.
    ...
    1720 => array(
        'type_id'     => 1720,
        'desc'        => esc_html__( 'User added application password from own profile', 'mainwp-child' ),
        'context'     => 'user',
        'action_name' => 'modified',
    ),
    1721 => array(
        'type_id'     => 1721,
        'desc'        => esc_html__( 'User removed application password from own profile', 'mainwp-child' ),
        'context'     => 'user',
        'action_name' => 'modified',
    ),
    1725 => array(
        'type_id'     => 1725,
        'desc'        => esc_html__( 'User added application password from another user’s profile', 'mainwp-child' ),
        'context'     => 'user',
        'action_name' => 'modified',
    ),
    1726 => array(
        'type_id'     => 1726,
        'desc'        => esc_html__( 'User removed application password from another user’s profile', 'mainwp-child' ),
        'context'     => 'user',
        'action_name' => 'modified',
    ),
    1730 => array(
    ...
    1810 => array(
        'type_id'     => 1810,
        'desc'        => esc_html__( 'Changed the setting: Allow people to submit comments on new posts', 'mainwp-child' ),
        'context'     => 'system-setting',
        'action_name' => 'enabled',
    ),
    1815 => array(
